<x-app-layout
    :active-page="'admin_edit_company'"
    :css="asset('css/admin/companies/edit.min.css')"
    :font-awesome="true"
>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-md-flex align-items-center">
                        <form class="w-100" method="POST" action="{{ route('admin.companies.update', ['company' => $company->id]) }}">
                            @method('PATCH')
                            @csrf
                            <div class="row">
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <x-input id="name" type="text" name="name" value="{{$company->name}}" placeholder="Google" required autofocus/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
