<x-app-layout
    :active-page="'supplier_import_promotion_urls'"
    :css="asset('css/supplier/promotion-urls/import.min.css')"
    :font-awesome="true"
>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('supplier.promotion-urls.parse-import') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-7">
                                <h4 class="card-title">
