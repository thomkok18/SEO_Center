<x-guest-layout
    :name-page="'Login'"
    :active-page="'login'"
    :css="asset('css/auth/login.min.css')"
    :font-awesome="false"
                        ...
                        <div class="header-body text-center mb-7">
                            <div class="row justify-content-center">
                                <div class="col-lg-12 col-md-9">
                                    <h1 class="text-white" style="font-size: 2em; line-height: 1.4em;">{{ __('Welcome to SEO Center.') }}</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-login card-plain">
                        ...
                        <div class="card-footer ">
                            ...
                            <div class="d-flex justify-content-end">
                                <a href="{{ route('password.request') }}" class="link footer-link font-weight-bold text-uppercase">{{ __('Forgot Password?') }}</a>
                            </div>
                        </div>
                    </div>
                </form>
