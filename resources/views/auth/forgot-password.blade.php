<x-guest-layout
    ...
    :active-page="''"
    :css="asset('css/auth/forgot-password.min.css')"
    :font-awesome="false"
                        ...
                        <div class="header-body text-center mb-7">
                            <div class="row justify-content-center">
                                <div class="col-lg-12 col-md-9">
                                    <h1 class="text-white" style="font-size: 2em; line-height: 1.4em;">{{ __('Forgot Password.') }}</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-login card-plain">
                        ...
                        <div class="card-body ">
                            ...
                            <div class="input-group no-border form-control-lg {{ $errors->has('email') ? ' has-danger' : '' }}">
                                ...
                                <input id="email" type="email" placeholder="{{__('user.email')}}" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                            </div>
                            @error('email')
